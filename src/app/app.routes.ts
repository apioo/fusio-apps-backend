...
import {ListComponent as TableList} from "./api/connection/designer/database/table/list/list.component";
import {DetailComponent as TableDetail} from "./api/connection/designer/database/table/detail/detail.component";
import {FormComponent as TableForm} from "./api/connection/designer/database/table/form/form.component";
import {ListComponent as RowList} from "./api/connection/designer/database/row/list/list.component";
import {DetailComponent as RowDetail} from "./api/connection/designer/database/row/detail/detail.component";
import {FormComponent as RowForm} from "./api/connection/designer/database/row/form/form.component";
import {FilesystemComponent} from "./api/connection/designer/filesystem/filesystem.component";
import {HttpComponent} from "./api/connection/designer/http/http.component";
import {SdkComponent} from "./api/connection/designer/sdk/sdk.component";
...
import {DetailComponent as MarketplaceBundleDetail} from "./development/marketplace/bundle/detail/detail.component";
...
import {List as SpecificationList} from "./development/specification/list/list";
...
export const routes: Routes = [
  ...
  { path: 'marketplace/bundle', component: MarketplaceBundleList, canActivate: [isAuthenticated] },
  { path: 'marketplace/bundle/:id', component: MarketplaceBundleDetail, canActivate: [isAuthenticated] },
  ...
  { path: 'specification', component: SpecificationList, canActivate: [isAuthenticated] },
